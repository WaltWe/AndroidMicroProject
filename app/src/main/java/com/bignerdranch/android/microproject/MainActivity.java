...
public class MainActivity extends AppCompatActivity {
    ...
    private void recipeInfo(){
        ...
        Recipe p0 = new Recipe("Pumpkin Bread", a1,a2,R.drawable.pumpkin_bread);
        ...
        Recipe p1 = new Recipe("Pumpkin Pie", b1,b2,R.drawable.pumpkin_pie);
        ...
        Recipe p2 = new Recipe("Pumpkin Jello", c1,c2,R.drawable.pumpkin_jello);
        ...
        Recipe p3 = new Recipe("Pumpkin Coffee", d1,d2,R.drawable.pumpkin_coffee);
